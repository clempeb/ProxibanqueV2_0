...
<div class="container"><center>
      ...
      <form class="form-signin" action="servcompte" method="post">
        <h2 class="form-signin-heading"><span class="glyphicon glyphicon-pencil"></span>      Virement      </h2>
        <label for="inputDebit">Numéro du compte à débiter</label>
        <input type="text" id="inputDebit" class="form-control" placeholder="Numéro de compte" required autofocus name="numDeb">
		
		<label for="inputCredit" class="">Numéro du compte à créditer</label>
        <input type="text" id="inputCredit" class="form-control" placeholder="Numéro de compte" required autofocus name="numCre">
        
        <label for="inputMontant" class="">Montant</label>
        <input type="text" id="inputMontant" class="form-control" placeholder="Montant" required autofocus name="montant">
		
        <input type="hidden" name="switch" value="virement">
